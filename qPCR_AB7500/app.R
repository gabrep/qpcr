...
ler_csv_corrigido <- function(arquivo) {
  linhas <- readLines(arquivo)  #Lê o arquivo exportado como texto bruto
  
  #Encontra a primeira linha que contém "Well" ou "Sample"
...
server <- function(input, output) {
  ...
  observeEvent(input$process, {
    ...
    #Obtém o nome do arquivo orginal e adiciona o sufixo "_processado"
    ...
    #Cria o dataframe de diferenças
